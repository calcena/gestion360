...
// Add a save button to the viewer toolbar
const saveButton = document.createElement("button");
saveButton.textContent = "Save PDF";
saveButton.id = "savePdfButton";
document.getElementById("toolbarContainer").appendChild(saveButton);

// Add event listener for saving the PDF
saveButton.addEventListener("click", async () => {
  ...
  try {
    // pdfDocument.saveDocument() is available in PDF.js >= 2.10. If not, this will fail.
