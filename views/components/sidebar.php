        ...
        <hr class="border border-1 border-secondary w-100" />
         <?php if ($_SESSION['user']['role_id'] == 1 ||$_SESSION['user']['role_id'] == 2 ): ?>
             <div class="menu-item text-center mt-3"
                 data-action="crear_tarea" data-nav-deep="<?php echo $GLOBALS['navigation_deep']; ?>">
             ...
             <hr class="border border-1 border-secondary w-100" />
         <?php endif; ?>
         <div class="menu-item text-center" data-action="salir" data-nav-deep="<?php echo $GLOBALS['navigation_deep'] ?>">
